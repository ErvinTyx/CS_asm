...
.DATA
 ...
 PRINTTTAX DB 13,10,"TOTAL TAXES: RM$"
 TOTALCASH DW 0
 TOTALSEN DW 0
 DISPLAYSEN DB 0
 DISPLAYCASH DW 0
...
SIGNUP_VALIDATION PROC
    ;--------------------------------------------------------------------
        SIGNUP_VALIDATION_P:
            ...
            CMP T_ERROR,0
            JE PRINT_EMSG_VAL;INVALID
            JNE END_SIGNUP_VALIDATION
        PRINT_EMSG_VAL:;
            CALL PROMPT_EMSG_TO
...
VALIDATION_P_SIGNUP PROC
    ...
    V_END_LOOP_CONNECTION:
     JMP V_END_LOOP
    CHCK_SC_RANGE2:
        CMP ENTERED_P[DI],3AH;SPECIAL_CHARACTER RANGE IS 
        JGE CHCK_SC_RANGE2_2
    CHCK_SC_RANGE2_2:
        CMP ENTERED_P[DI],40H
        JLE VALID_SC
        JG CHCK_UPPERCASE_RANGE1
    ;-----------------------------------
    ...
    V_END_LOOP:
        ...
        LOOP_AGAIN_VALIDATION:
            ...
            JMP CHCK_SC_RANGE1_1
    OPERATION_VALID:
        MOV AL,B_VLC;GOT LOWERCASE
        AND AL,B_VUC;GOT UPPERCASE
        AND AL,B_VSC;GOT SPECIAL CHARACTER
        AND AL,B_VNUM; GOT NUMBER
        AND AL,B_VL;VALID LENGTH
        MOV T_ERROR,AL
    RET
